...
@section('content')
    ...
    <div class="ficheclient mt-5">
            ...
            <div class="container p-0 d-flex">
                ...
                <form role="form">
                    <label class="radio-inline pl-3">
                        <input type="radio" name="optradio" disabled>Madame
                    </label>
                    <label class="radio-inline pl-3">
                        <input type="radio" name="optradio" disabled>Monsieur
                    </label>
                </form>
            </div>
            <div class="form-row">
        ...
        <div class="row">
        <form class="col-sm-6 border border-dark">
                ...
                <div class="row mt-5">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xs-4">
                                ...
                                <input type="number" class="form-control" placeholder="Numéro" disabled>
                            </div>
                        </div>
                        <div>
                            <div class="justify-content-end d-flex">
                                <button type="submit" class="btn btn-primary d-block ">MODIFIER</button>
                            </div>
                            <div class="justify-content-end d-flex">
